...
axios.get(`${import.meta.env.VITE_Backend_api_url}/users/${friend._id}/follow-unfollow`, {
...
<button className='friendRequest__actions-approve' 
onClick={followUser}><FaCheck/></button>
<button className='friendRequest__actions-cancel' 
onClick={()=> onFilterFriend(friend?._id)}><IoMdClose/></button>
     </div>
